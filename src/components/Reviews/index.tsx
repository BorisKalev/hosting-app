...
const Reviews = () => {
  const reviews = [
    {
      name: "Marc Butler",
      body: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illo libero mollitia magni ullam, hic nesciunt.",
      image: user,
    },
    {
      name: "Bob Little",
    ...
    <div className="w-full md:px-[80px] px-8 py-16 flex flex-col gap-16 items-center justify-center">
      <div className="flex flex-col items-center justify-center gap-2">
        ...
        <p className="text-center max-w-[700px] text-gray-300">
          ...
          voluptatum ad dicta ipsam repudiandae ipsum optio, tempora in
          explicabo.
        </p>
      </div>
      <div className="flex w-full items-center md:flex-row flex-col justify-between md:px-[80px] px-8 md:gap-0 gap-10">
        {reviews.map((review, index: number) => (
          ...
          >
            ...
            />
            <span className="font-bold text-indigo-200 text-[18px]">
              {review.name}
            </span>
            <p className="leading-8 max-w-[400px] text-center text-[17px]">
              {review.body}
            </p>
            <div className="flex items-center gap-1">
              <Star color={"#FFD700"} width={"21px"} height={"21px"} />
              <Star color={"#FFD700"} width={"21px"} height={"21px"} />
              <Star color={"#FFD700"} width={"21px"} height={"21px"} />
              <Star color={"#FFD700"} width={"21px"} height={"21px"} />
              <StarHalf color={"#FFD700"} width={"21px"} height={"21px"} />
            </div>
          </div>
        ))}
      </div>
