...
const Companies = () => {
  return (
    <div className="w-full md:px-[80px] px-8 pb-16 flex flex-col gap-8 items-center justify-center">
      <div className="flex flex-col items-center justify-center gap-2">
        ...
        <p className="text-center max-w-[700px] text-gray-300">
          ...
          fuga commodi soluta libero sunt perferendis cumque nemo deleniti
